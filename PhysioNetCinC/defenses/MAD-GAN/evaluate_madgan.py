...
def evaluate_madgan(output_directory):
    ...
    os.system('python RGAN.py --settings_file sepsis > '+str(output_directory)+"/more/train.txt")
    ...
    for cv in range(5):
        ...
        print('CV: ' + str(cv))
        os.system('python AD.py --settings_file sepsis_test > '+str(output_directory)+"/more/test_more_" + str(cv) + '.txt')
    ...
    os.system('python RGAN.py --settings_file sepsis > '+str(output_directory)+"/less/train.txt")
    ...
    for cv in range(5):
        ...
        print('CV: ' + str(cv))
        os.system('python AD.py --settings_file sepsis_test > '+str(output_directory)+"/less/test_less_" + str(cv) + '.txt')
    ...
    os.system('python RGAN.py --settings_file sepsis > '+str(output_directory)+"/all_benign/train.txt")
    ...
    for cv in range(5):
        ...
        print('CV: ' + str(cv))
        os.system('python AD.py --settings_file sepsis_test > '+str(output_directory)+"/all_benign/test_all_" + str(cv) + '.txt')
    ...
    os.system('python RGAN.py --settings_file sepsis > '+str(output_directory)+"/all/train.txt")
    ...
    for run in range(5):
        ...
        os.system('python RGAN.py --settings_file sepsis > '+str(output_directory)+"/samples/train_"+ str(run) + '.txt')
        ...
        for cv in range(5):
            ...
            print('CV: ' + str(cv))
            os.system('python AD.py --settings_file sepsis_test > '+str(output_directory)+"/samples/test_run_" + str(run) + '_' + str(cv) + '.txt')
...
if __name__ == '__main__':
	parser = argparse.ArgumentParser(
		description="Run PhysioNetCinC script: python evaluate_madgan.py <output_directory>",
